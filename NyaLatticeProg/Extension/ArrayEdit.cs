...
namespace Extension.Array
{
    public static class ArrayEdit
    {
        ...
        static public Int16 ReadInt16(this byte[] Data, long Offset)
        {
            if (Data == null) return 0;
            return Convert.ToInt16((Data[Offset + 0]) | // LSB
                    (Data[Offset + 1] << 8)); // MSB
        }
        ...
        static public Int32 ReadInt32(this byte[] Data, long Offset)
        {
            return (int)(((uint)Data[Offset + 0]) |
                        ((uint)Data[Offset + 1] << 8) |
                        ((uint)Data[Offset + 2] << 16) | // MSB
                        ((uint)Data[Offset + 3] << 24)); // LSB
        }
        ...
        static public float ReadFloat(this byte[] Data, long Offset)
        {
            return BitConverter.ToSingle(Data.ReadArray(Offset, 4), 0);
        }
